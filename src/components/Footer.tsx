...
const Footer = () => {
  ...
  return (
    <footer className="teal-gradient text-white pt-16 pb-8">
      <div className="container-custom">
        <div className="flex justify-center mb-10">
          <div className="w-20 h-12 flex items-center justify-center bg-white/10 backdrop-blur-sm rounded-xl border border-secondary/30 shadow-lg">
            <img 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-serif font-semibold mb-6 gold-accent">Mungai & Njenga</h3>
            <p className="text-white/80 mb-6 leading-relaxed">
              Providing exceptional legal counsel with integrity, expertise, and personalized attention.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-white/70 hover:text-secondary transition-all duration-300 transform hover:scale-110" aria-label="LinkedIn">
              ...
              <a href="#" className="text-white/70 hover:text-secondary transition-all duration-300 transform hover:scale-110" aria-label="Twitter">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"></path>
                </svg>
              </a>
              <a href="#" className="text-white/70 hover:text-secondary transition-all duration-300 transform hover:scale-110" aria-label="Facebook">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-medium mb-6 gold-accent">Quick Links</h4>
          ...
          {/* Practice Areas */}
          <div>
            <h4 className="text-lg font-medium mb-6 gold-accent">Practice Areas</h4>
            <ul className="space-y-3">
              <li>
          ...
          {/* Contact */}
          <div>
            <h4 className="text-lg font-medium mb-6 gold-accent">Contact Us</h4>
